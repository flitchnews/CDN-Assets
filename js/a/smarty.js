                ...
                if ("code" in r[t] && "placement_id" in r[t] && "sizes" in r[t])
                    if (!r[t].sizes instanceof Array || r[t].sizes.length < 2 || isNaN(parseInt(r[t].sizes[0])) || isNaN(parseInt(r[t].sizes[1]))) console.log(d);
                        ...
                        if (null != n) {
                            ...
                            o += "placementId=" + r[t].placement_id, a.src = location.protocol + "//42oxsq.flitch.news/?" + o, a.setAttribute("width", r[t].sizes[0]), a.setAttribute("height", r[t].sizes[1]), n.appendChild(a)
